...
gc.fillOval(pelotaX, pelotaY, 5,5);

// Draw ships
gc.fillRect(jug1X, jug1Y, 8, 15);
gc.fillRect(jug2X, jug2Y, 8, 15);
...
jug1Y += abajo;
if (player1FlagAba == true && jug1Y <= (this.getHeight()-30))
jug1Y += arriba;
...
jug2Y += abajo;
if (player2FlagAba == true && jug2Y <= (this.getHeight()-30))
jug2Y += arriba;
